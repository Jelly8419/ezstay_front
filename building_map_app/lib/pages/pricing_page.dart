...
class _PricingPageState extends State<PricingPage> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '보증금은 아카스테이에 안전하게 보관되며 호스트(임대인)와의 최상 상태를 확인한 후 게스트에게 반환됩니다.',
                    style: TextStyle(
                      fontSize: 12,
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: const BorderSide(color: Color(0xFF4DB5BD), width: 2),
                      ),
                    ),
                  ),
                ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '한국 관리비는 가격으로 고려하여 관리비에 포함시킬 것을 추천드립니다.',
              style: TextStyle(
                fontSize: 12,
                color: Colors.grey[600],
              ),
            ...
            Row(
              children: [
                Expanded(
                  child: _buildInclusionButton('전기', _includeElectricity, (value) {
                    setState(() {
                ...
                const SizedBox(width: 12),
                Expanded(
                  child: _buildInclusionButton('수도', _includeWater, (value) {
                    setState(() {
                      _includeWater = value;
                    });
                  }),
            ...
            Row(
              children: [
                Expanded(
                  child: _buildInclusionButton('가스', _includeGas, (value) {
                    setState(() {
                      _includeGas = value;
                    });
                  }),
                ...
                const SizedBox(width: 12),
                Expanded(
                  child: _buildInclusionButton('인터넷', _includeInternet, (value) {
                    setState(() {
            ...
            TextFormField(
              ...
              maxLines: 4,
              decoration: InputDecoration(
                hintText: '모든 관리로운 관리비에 포함되어 있습니다.',
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(12),
                ),
                focusedBorder: OutlineInputBorder(
            ...
            Container(
              ...
              child: Text(
                '퇴실 청소비가 설정되지 않은 경우, 청소 후 퇴실 및 반환대에 반환 계스트에게 반환 됩니다.',
                style: TextStyle(
                  fontSize: 12,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              '설정 하신 최소 계약기가 미만으로는 계약이 신청 됩니다.',
              style: TextStyle(
                fontSize: 12,
                color: Colors.grey[600],
              ),
  ...
  Widget _buildInclusionButton(String label, bool isSelected, Function(bool) onChanged) {
    return Container(
      decoration: BoxDecoration(
        border: Border.all(
            ...
            onPressed: () {
              if (_formKey.currentState!.validate()) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('요금 설정이 저장되었습니다')),
                );
              }
            },
