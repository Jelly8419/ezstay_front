                      ...
                      children: [
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            ...
                            child: Text('불가 기간 설정', style: AppTextStyles.labelMedium),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            ...
                            child: Text('가능 기간 설정', style: AppTextStyles.labelMedium),
                          ),
                        ),
                      ],
                    )
                          ...
                          children: [
                            Expanded(
                              child: OutlinedButton(
                                ...
                                child: Text('취소', style: AppTextStyles.labelMedium),
                              ),
                            ),
                            ...
                            Expanded(
                              child: ElevatedButton(
                                ...
                                child: Text('적용', style: AppTextStyles.labelMedium.copyWith(color: Colors.white)),
                              ),
                            ),
                          ],
                        )
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      child: Text('삭제', style: AppTextStyles.bodySmall),
                    ),
                  ],
                ),
              );
