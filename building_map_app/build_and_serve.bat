...
chcp 65001 >nul
REM 프로덕션 빌드 및 서버 실행 스크립트 (Windows)
REM 사용법: build_and_serve.bat

echo ========================================
echo   EZStay Production Build
echo ========================================
echo.
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo.
    npx serve -p 3000 --no-port-switching --single
) else (
    echo [ERROR] Node.js is not installed
    echo.
    echo Solutions:
    echo   1. Install Node.js from https://nodejs.org/
    echo   2. Use Python version: build_and_serve_python.bat
